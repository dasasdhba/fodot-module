...
/// <summary>
/// Base class of OverlappingObjects (3D).
/// Using Component.OverlapManager3D object as base API.
/// </summary>
[GlobalClass]
public abstract partial class Overlapping3D : Node
{

    /// <summary>
    /// The manager that needs to override.
    /// </summary>
    protected abstract Overlap3D GetOverlapManager();

    [ExportCategory("Overlapping3D")]
    ...
    public void AddException(CollisionObject3D col) => GetOverlapManager().AddException(col);
    public void AddException(Rid rid) => GetOverlapManager().AddException(rid);
    public void RemoveException(CollisionObject3D col) => GetOverlapManager().RemoveException(col);
