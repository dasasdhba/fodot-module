...
public static class FSharpExtensions
{
    ...
    {
        NodeGame.NodeModule.whenReady(action.AsFSharpFunc(), node);
    }
    ...
    {
        return ActionModule.repeat(interval, physics, action.AsFSharpFunc(), node);
    }
    ...
    {
        return ActionModule.delay(interval, physics, action.AsFSharpFunc(), node);
    }
